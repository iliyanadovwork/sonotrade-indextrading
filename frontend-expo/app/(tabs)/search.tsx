import { View, Text, StyleSheet, TextInput, FlatList, Pressable, StatusBar, Image, useWindowDimensions, Animated } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => <ArtistCard item={item} cardWidth={cardWidth} />}
        ListHeaderComponent={
          <>
