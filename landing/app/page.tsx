...
import { SXMonogramBackground } from '@/components/sx/SXMonogramBackground'
    ...
    const fetchAll = async () => {
      const results = await Promise.all(
        HERO_ARTISTS.map(async (name) => {
          try {
            const res = await fetch(`/api/artist/${encodeURIComponent(name)}?slim=true`)
  ...
  return (
    <>
      ...
      <div className="hidden md:block min-h-screen">
        {/* Logo-only header */}
        <header className="sticky top-0 z-[1000] border-b border-st-border bg-[rgb(10,10,10)] flex items-center" style={{ height: '68.555px', transform: 'translateZ(0)', WebkitTransform: 'translateZ(0)' }}>
          <div className="w-full mx-auto flex min-w-0 max-w-[1300px] items-center xl:-translate-x-[7px]">
            <div className="flex items-center gap-0 select-none" style={{ width: 'fit-content' }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/st-glyph.png" alt="Sonotrade" style={{ height: '32px', width: 'auto', display: 'block' }} />
              <span style={{ fontSize: '1.5rem', fontWeight: 400, letterSpacing: '-0.05em', color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)', lineHeight: 1.5 }}>
                Sonotrade
              </span>
            </div>
          </div>
        ...
        <section className="border-b relative overflow-hidden" style={{
          ...
          <div className="w-full max-w-[1300px] mx-auto py-20 sm:py-44 relative" style={{ zIndex: 1 }}>
            <div className="flex items-center gap-16">
              <div className="flex-1 min-w-0 max-w-xl">
                <h1 className="mb-6 m-0 p-0 text-3xl sm:text-4xl lg:text-5xl font-light leading-tight text-balance" style={{ color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)' }}>
                ...
                <div className="mt-8">
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-full px-6 py-2 text-sm font-medium tracking-wide transition-all duration-75 hover:opacity-80 active:scale-90"
                    style={{ backgroundColor: 'var(--st-white)', color: 'rgb(10,10,10)', fontFamily: 'var(--font-geist-sans)' }}
                  >
                    Join Waitlist
                  </button>
                </div>
                ...
                <div className="mb-6 flex flex-col gap-4">
                  <div className="flex items-center gap-4">
                    {artist?.image_url ? (
                      ...
                      <div className="h-16 w-16 flex-shrink-0 rounded-full bg-zinc-800" style={{ minWidth: 64, minHeight: 64 }} />
                    )}
                    <h2 className="m-0 min-w-0 p-0 text-3xl font-light" style={{ color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)' }}>
                      {artist?.name ?? ''}
                    </h2>
                  </div>
                  <NumberFlowGroup>
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-3">
                      <AnimatedPrice
                        ...
                        color="STWhite"
                      />
                      <span className="text-2xl font-light" style={{ color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)' }}>
                        points
                      </span>
                    </div>
                    {changeData && (
        ...
        <section id="foundations" className="border-b relative" style={{ borderColor: 'var(--st-border)', backgroundColor: 'rgb(10,10,10)', zIndex: 2 }}>
          <div className="w-full max-w-[1300px] mx-auto py-16 sm:py-32">
            <div className="flex gap-20">
              {/* Left column with logos and lines */}
              <div className="hidden lg:flex flex-col items-start justify-center" style={{ width: '560px' }}>
                {/* Streaming service logos */}
                <div className="flex items-center justify-between w-full px-4 mb-0 relative" style={{ height: '64px' }}>
                ...
                {/* Lines merging */}
                <svg width="560" height="258" viewBox="0 0 560 258" className="overflow-visible">
                  <defs>
                    <path id="lpath1" d="M 48 0 L 48 140 L 280 200 L 280 258" />
                    <path id="lpath2" d="M 203 0 L 203 140 L 280 200 L 280 258" />
                    <path id="lpath3" d="M 357 0 L 357 140 L 280 200 L 280 258" />
                    <path id="lpath4" d="M 512 0 L 512 140 L 280 200 L 280 258" />
                  </defs>
              ...
              <div className="flex-1">
                <div className="mb-12">
                  <span className="text-xs uppercase tracking-widest" style={{ color: 'var(--st-secondary)', fontFamily: 'var(--font-geist-sans)' }}>
                    WHAT IS SONOTRADE
                  </span>
                </div>
        ...
        <section className="relative" style={{ backgroundColor: 'rgb(10,10,10)', zIndex: 2 }}>
          <div className="w-full max-w-[1300px] mx-auto py-16 sm:py-32">
            <div className="flex gap-28">
              <div className="hidden lg:flex flex-col items-center justify-center" style={{ width: '560px' }}>
              ...
              <div className="flex-1">
                ...
                <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
                  <div className="space-y-3">
                    <div className="flex items-center gap-4">
                      <div className="text-6xl font-light" style={{ color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)' }}>01</div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-4">
                      <div className="text-6xl font-light" style={{ color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)' }}>02</div>
                  ...
                  <div className="space-y-3 md:col-span-2">
                    <div className="flex items-center gap-4">
                      <div className="text-6xl font-light" style={{ color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)' }}>03</div>
        ...
        <section id="data-research" className="border-t border-b relative" style={{ borderColor: 'var(--st-border)', backgroundColor: 'rgb(10,10,10)', zIndex: 2 }}>
          <div className="w-full max-w-[1300px] mx-auto py-16 sm:py-32">
            <div className="flex gap-20">
              ...
              <div className="hidden lg:flex items-center justify-center" style={{ width: '460px' }}>
                <SXRadarGraphic />
              </div>
            </div>
          </div>
        ...
        <section id="ar-team" className="border-b relative" style={{ borderColor: 'var(--st-border)', backgroundColor: 'rgb(10,10,10)', zIndex: 2 }}>
          <div className="w-full max-w-[1300px] mx-auto py-16 sm:py-32">
            ...
            <div className="flex flex-col gap-5 mb-12">
              <h2 className="m-0 p-0 text-3xl sm:text-4xl font-light leading-tight" style={{ color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)' }}>
        ...
        <section className="border-b relative" style={{ borderColor: 'var(--st-border)', backgroundColor: 'rgb(10,10,10)', zIndex: 2 }}>
          <div className="w-full max-w-[1300px] mx-auto py-16 sm:py-24">
            <div className="flex flex-col gap-8 p-8 sm:p-12 rounded-2xl" style={{ border: '1px solid var(--st-border)', backgroundColor: 'rgba(255,255,255,0.02)', position: 'relative', overflow: 'hidden' }}>
              <div aria-hidden style={{ position: 'absolute', inset: 0, backgroundImage: 'linear-gradient(var(--st-border) 1px, transparent 1px), linear-gradient(90deg, var(--st-border) 1px, transparent 1px)', backgroundSize: '48px 48px', opacity: 0.3, zIndex: 0 }} />
              <div className="relative flex flex-col gap-4" style={{ zIndex: 1 }}>
                <div className="flex items-center gap-3">
                  <span className="text-xs uppercase tracking-widest" style={{ color: 'var(--st-secondary)', fontFamily: 'var(--font-geist-sans)' }}>
                    ENTERPRISE API
                  </span>
                  <span className="text-[10px] uppercase tracking-widest px-2 py-0.5 rounded" style={{ color: 'var(--st-secondary)', border: '1px solid var(--st-border)', fontFamily: 'var(--font-geist-sans)', backgroundColor: 'rgba(255,255,255,0.04)' }}>
                    Coming soon
                  </span>
                </div>
                <h2 className="m-0 p-0 text-2xl sm:text-3xl font-light leading-snug" style={{ color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)' }}>
              ...
              <div className="relative flex flex-col gap-3" style={{ zIndex: 1 }}>
                {[
                  ...
                  <div key={row.endpoint} className="flex items-center justify-between gap-4 px-4 py-2.5 rounded-lg" style={{ border: '1px solid var(--st-border)', backgroundColor: 'rgba(10,10,10,0.8)' }}>
                    ...
                    <span className="text-[10px] shrink-0" style={{ color: 'var(--st-secondary)', fontFamily: 'var(--font-geist-sans)' }}>
                      {row.desc}
                    </span>
                  </div>
                ))}
        ...
        <section className="border-t relative overflow-hidden" style={{ borderColor: 'var(--st-border)', backgroundColor: 'rgb(10,10,10)', zIndex: 2 }}>
          <SXMonogramBackground opacity={0.07} noMask />
          <div className="w-full max-w-[1300px] mx-auto py-32 sm:py-48 flex flex-col items-center text-center gap-6 relative" style={{ zIndex: 1 }}>
            <h2
              className="m-0 p-0 text-4xl sm:text-5xl lg:text-6xl font-light leading-tight text-balance"
              style={{ color: 'var(--st-white)', fontFamily: 'var(--font-geist-sans)', maxWidth: 720 }}
            >
            ...
            <button
              onClick={() => setShowWaitlist(true)}
              className="mt-4 inline-flex items-center justify-center rounded-full px-6 py-2 text-sm font-medium tracking-wide transition-all duration-75 hover:opacity-80 active:scale-90"
              style={{ backgroundColor: 'var(--st-white)', color: 'rgb(10,10,10)', fontFamily: 'var(--font-geist-sans)' }}
            >
              Join Waitlist
            </button>
